...
export type FontMood = 'professional' | 'playful' | 'luxurious' | 'technical' | 'warm' | 'bold' | 'minimal';
...
const CURATED_PAIRINGS: FontPairing[] = [
  ...
  },
  {
    ...
    mood: 'playful',
    embedHtml:
      '<link href="https://fonts.googleapis.com/css2?family=Fredoka:wght@500;700&family=Nunito:wght@400;600&display=swap" rel="stylesheet">',
  ...
  // Luxurious / Premium
  {
    ...
    mood: 'luxurious',
    embedHtml:
      '<link href="https://fonts.googleapis.com/css2?family=Cormorant+Garamond:wght@600;700&family=Montserrat:wght@300;400&display=swap" rel="stylesheet">',
    cssVariables:
  ...
  },
  {
    ...
    mood: 'luxurious',
    embedHtml:
      '<link href="https://fonts.googleapis.com/css2?family=Libre+Baskerville:wght@700&family=Raleway:wght@300;400&display=swap" rel="stylesheet">',
    cssVariables:
  ...
  },
  {
    ...
    mood: 'technical',
    embedHtml:
      '<link href="https://fonts.googleapis.com/css2?family=Space+Mono:wght@700&family=Work+Sans:wght@400;500&display=swap" rel="stylesheet">',
...
export class FontService {
   ...
   */
  getPairings(options: { mood: FontMood; existingFont?: string }): FontPairing[] {
  ...
  async validate(font: {
    ...
    const missingSubsets = (font.requiredSubsets ?? []).filter((s) => !match.subsets.includes(s));
   ...
   */
  getEmbedCode(fonts: Array<{ family: string; weights: number[]; italic?: boolean }>): string {
